<?php
	$tabellen_spalten_namen = array("Prüfungsfach", "Art der Prüfung", "Kürzel", "Termine", "Zusage von Experte/Expertin", "");
	$tabellen_spalten_anzahl = count($tabellen_spalten_namen);
?>

<div id="anchor_tabelle1"></div>
	...
	<tr>
		<td style="width:900px" valign="top">
			<div id="content_left" style="padding-top: 0px; padding-bottom: 15px; float:left;">
				<p><b>Anfragen an alle Experten/Expertinnen:</b>&nbsp;&nbsp;&nbsp;&nbsp;<img style="position:relative; top:3px; border: 0 none;" src="assets/experte_plural.jpg"/></p>
			</div>
			<div align="right" style="padding-top: 0px; padding-bottom: 15px; color:#FFF; font-size: 1em; float:right;">
				<!--<p><a style="" href="#anchor_tabelle2">>>Anfragen an einzelne Experten/Expertinnen</a></p>-->
			</div>
		</td>
	</tr>
</table>
...
<table style="position:relative; top:0px; z-index:99; border-spacing:0pt;">
	...
	<tr>
		<?php
			$td_style[0] = "padding:10px; background: #DDD; border-top: 1px solid #000000; border-left: 1px solid #000000; border-spacing:0pt; width:100px;";
			$td_style[1] = "padding:10px; background: #DDD; border-top: 1px solid #000000; border-left: 1px solid #000000; border-spacing:0pt; width:120px;";
			$td_style[2] = "padding:10px; background: #DDD; border-top: 1px solid #000000; border-left: 1px solid #000000; border-spacing:0pt; width:60px;";
			...
			$td_style[4] = "padding:10px; background: #DDD; border-top: 1px solid #000000; border-left: 1px solid #000000; border-spacing:0pt; width:220px;";
	...
	<tr>
		<?php 
			$td_style[0] = "padding-top:4px; padding-bottom:0px; background: #EEE; border-top: 1px solid #000000; border-left: 1px solid #000000; border-spacing:0pt; width:100px;";
			$td_style[1] = "padding-top:4px; padding-bottom:0px; background: #EEE; border-top: 1px solid #000000; border-left: 1px solid #000000; border-spacing:0pt; width:120px;";
			$td_style[2] = "padding-top:4px; padding-bottom:0px; background: #EEE; border-top: 1px solid #000000; border-left: 1px solid #000000; border-spacing:0pt; width:60px;";
			...
			$td_style[4] = "padding-top:4px; padding-bottom:0px; background: #EEE; border-top: 1px solid #000000; border-left: 1px solid #000000; border-spacing:0pt; width:220px;";
		...
		<td align="center" style="<?php echo $td_style[$i2]; ?>" valign="top">
			<div ><?php if($i2<5 && $i2 !=3){?>
				<a style="text-decoration: none;" href="./schule.php?rubrik=0&sort=<?php echo $i2*2; ?>#anchor_tabelle1" target="_self"><img style="border: 0 none;" src="<?php if($sort ==($i2*2)){echo "assets/sorter_oben_ddd.png"; } else {echo "assets/sorter_oben_aaa.png"; }?>"/></a> 
				<a style="text-decoration: none;" href="./schule.php?rubrik=0&sort=<?php echo $i2*2+1; ?>#anchor_tabelle1" target="_self"><img style="border: 0 none;" src="<?php if($sort ==($i2*2+1)){echo "assets/sorter_unten_ddd.png"; } else {echo "assets/sorter_unten_aaa.png"; }?>"/></a> 
				<?php } ?>
			</div>
		</td>
		<?php }?>
	...
	<tr>
		<?php 
			$td_style[0] = "padding:10px; padding-top: 2px; border-top:1px solid #000000; border-left:1px solid #000000; border-spacing:0pt; width:100px;";
			$td_style[1] = "padding:10px; padding-top: 2px; border-top:1px solid #000000; border-left:1px solid #000000; border-spacing:0pt; width:120px;";
			$td_style[2] = "padding:10px; padding-top: 2px; padding-bottom: 2px; border-top:1px solid #000000; border-left:1px solid #000000; border-spacing:0pt; width:60px;";
			...
			$td_style[4] = "padding:10px; padding-top: 2px; border-top:1px solid #000000; border-left:1px solid #000000; border-spacing:0pt; width:220px;";
		...
		<td style="<?php echo $td_style[$i2]; ?>" valign="top">
			<?php if($i2 == 0){?> 
				<p><?php echo $tabellen_zeilen_DATA[$i][$i2]; ?></p>
			<?php }; ?> 
			<?php if($i2 == 1){?> 
				<p><?php echo $tabellen_zeilen_DATA[$i][$i2]; ?></p>
			<?php }; ?> 
			<?php if($i2 == 2){?> 
				<p><?php echo $tabellen_zeilen_DATA[$i][8]; ?></p>
			<?php }; ?>
			<?php if($i2 == 3){ 
			...
			<?php if($i2 == 5){?> 
				<p>
					<?php if($zusage_ID[$tabellen_zeilen_DATA[$i][4]]) { ?>
							<img style="cursor:pointer; border: 0 none;" src="assets/papierkorb.png" onclick="document.forms[0].form_anfrage_aktiv.value= 3; document.forms[0].papierkorb_geklickt.value='<?php echo $tabellen_zeilen_DATA[$i][4]."-".$zusage_ID[$tabellen_zeilen_DATA[$i][4]]; ?>'; document.forms[0].submit()" /> 
					<?php } else { ?>
							<img style="cursor:pointer; border: 0 none;" src="assets/papierkorb.png" onclick="document.forms[0].form_anfrage_aktiv.value= 3; document.forms[0].papierkorb_geklickt.value='<?php echo $tabellen_zeilen_DATA[$i][4]."-0"; ?>'; document.forms[0].submit()" /> 
					<?php } ?>
				</p>
			<?php }; ?> 
		</td>
