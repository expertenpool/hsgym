<?php
	...
	if($_POST["form1_aktiv"]){
		...
		if ($login_error == 0) {
			...
			if ($num_rows > 0) {
				//echo "ja";
				$sql = sprintf("UPDATE experte SET reset_link = '%s', reset_time = '%s' WHERE (email = '%s')",
				...
				$mailBody = "Guten Tag \n\nSie sind als Experte im Expertenpool der HSGYM angemeldet.\n";
				...
				$mailBody .= "\n\nhttp://www.hsgym-expertenpool.ch/pass_reset.php?v0=experte&v1=".$_POST['email_experte']."&v2=".$zufall_reset_link;
			...
			$_SESSION['info_zeile'] = "Falls ein Experten-Konto mit dieser E-Mail-Adresse existiert und aktiviert ist, dann wurde soeben ein E-Mail abgesendet. <br/>Bitte folgen Sie den Anweisungen in diesem E-Mail.";
		}
	}
?>
	...
	<tr>
		<td style="border-right: 1px solid #000000; width:450px" valign="top">
			<div id="content_left">
				...
				<form method="post">
					<p>Sie haben sich als Expertin oder Experte registriert, jedoch Ihr Passwort vergessen?</p>
					...
					<table style="font-size: 1em;">
						<tr>
							...
							<td style="width:230px;" valign="top">
								...
								<input type="password" autocomplete="off" name="email_experte" value="" style="width: 220px">
							</td>
							<td style="width:70px" valign="top">
